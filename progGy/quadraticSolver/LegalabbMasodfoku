...
class Program {
  ...
  public static (double x1, double x2, bool van)
    ...
    if (a == 0 && b == 0 && c == 0) {
      ...
      x1 = -c / b;
      x2 = x1;
    } else // Nem lehet else if (a != 0) mert a compiler valamiért nem kezeli
           // jól
    {
      if (diszk > 0) {
        van = true;
